...
const Dialogs = (props) => {
    ...
    let DialogsElements = state.dialogs.map(dialog => <Dialog id={dialog.id} friend={dialog.friend} />)

    let MessagesElements = state.messages.map(message => <Message text={message.text} message_class={message.message_class} />)
